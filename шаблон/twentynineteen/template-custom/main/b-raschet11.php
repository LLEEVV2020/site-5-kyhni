        ...
        <script type="text/javascript">
            stoim1mkv = 25216;   //старая стоимость 1 м2
            stoim1mkvnew = 7100;
        ...
        <div class="b-raschet">
            <div class="container">
                <div class="h2">БЫСТРЫЙ РАСЧЕТ СТОИМОСТИ КУХНИ </div>
                <div class="b-raschet__form ">
                    <form>
                        <div class="b-form__block">
                            <div class="b-form__item">
                                <div class="b-form_lbl">Введите ширину кухни</div>
                            </div>
                            <div class="b-form__item">
                            ...
                            <div class="b-form__item">
                                    <span id="sksksk">25216</span> <span style="display:none;">р.</span>
                            </div>
                            <div class="b-form__item">
                ...
                <div class="b-raschet__ttl1">Звоните прямо сейчас и получите самое выгодное предложение!
 <br> <strong>Дешевле кухни нет нигде!</strong></div>
            </div>
        </div>
<!--b-raschet"-->